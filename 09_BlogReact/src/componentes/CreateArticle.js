                ...
                <section id="content">
                    ...
                    <form className="mid-form"  onSubmit={this.saveArticle} > 
                        <div className="form-group">
                            ...
                            <input type="text" name="titulo"  ref={this.titleRef} onChange={this.changeState} />
                        ...
                        <div className="form-group">
                            ...
                            {this.validator.message('contenido',this.state.article.title, 'required|alpha_num_space')}
                        </div>
