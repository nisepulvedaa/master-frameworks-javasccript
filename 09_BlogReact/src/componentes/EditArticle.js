...
///4actualizar el objeto haciendo una peticion al backend
                ...
                <section id="content">
                    ...
                    {this.state.article.title &&
                        ...
                        <div className="form-group">
                            ...
                            <input type="text" name="titulo" defaultValue={article.title}  ref={this.titleRef} onChange={this.changeState} />
